...
public class RotateBitmap {
    ...
    // Function to Rotate and Rescale the Image
    ...
    // Function to calculate Image Sample Size
    private static int calculateInSampleSize(BitmapFactory.Options options,
        ...
        if (height > reqHeight || width > reqWidth) {
            ...
            // Choose the smallest ratio as inSampleSize value, this will guarantee a final_image image
    ...
    // Function to Rotate image if Required
